...
[image layer=2 page=fore name="bgm_gauge" storage="config_exte.png" x=340 y=270 visible=true]
[image layer=2 page=fore name="bgm_gauge" storage="config_exte.png" x=440 y=270 visible=true]
[image layer=2 page=fore name="bgm_gauge" storage="config_exte.png" x=540 y=270 visible=true]
...
;6の時
[if exp="sf.font_f==5"]
[image layer=2 name="font_face_button" page=fore  storage="font_face_a.png" x=&tf.config_button_0_x_1 y=&tf.font_button_6_y visible=true]
[image layer=1 name="font_face_button" page=fore storage="config_button_0.png" x=&tf.config_button_0_x_1 y=&tf.font_button_6_y visible=true]
[else]
[button fix="true" name="font_face_button" target="*text_test" exp="sf.font_f=5" graphic="font_face_a.png" x=&tf.config_button_0_x_1 y=&tf.font_button_6_y]
[image layer=1 name="font_face_button" page=fore storage="config_button_1.png" x=&tf.config_button_0_x_1 y=&tf.font_button_6_y visible=true]
[endif]

;5
[if exp="sf.font_f==3"]
[image layer=2  name="font_face_button" name="font_face_button" page=fore storage="font_face_b.png" x=&tf.config_button_0_x_2 y=&tf.font_button_6_y visible=true]
[image layer=1  name="font_face_button" page=fore storage="config_button_0.png" x=&tf.config_button_0_x_2 y=&tf.font_button_6_y visible=true]
[else]
[button fix="true"  name="font_face_button" target="*text_test" exp="sf.font_f=3" graphic="font_face_b.png" x=&tf.config_button_0_x_2 y=&tf.font_button_6_y]
[image layer=1  name="font_face_button" page=fore storage="config_button_1.png" x=&tf.config_button_0_x_2 y=&tf.font_button_6_y visible=true]
[endif]

;３
[if exp="sf.font_f==2"]
[image layer=2 name="font_face_button" page=fore  storage="font_face_c.png" x=&tf.config_button_0_x_3 y=&tf.font_button_6_y visible=true]
[image layer=1  name="font_face_button" page=fore storage="config_button_0.png" x=&tf.config_button_0_x_3 y=&tf.font_button_6_y visible=true]
[else]
[button fix="true"  name="font_face_button" target="*text_test" exp="sf.font_f=2" graphic="font_face_c.png" x=&tf.config_button_0_x_3 y=&tf.font_button_6_y]
[image layer=1  name="font_face_button" page=fore storage="config_button_1.png" x=&tf.config_button_0_x_3 y=&tf.font_button_6_y visible=true]
[endif]

;2
[if exp="sf.font_f==6"]
[image layer=2 name="font_face_button" page=fore  storage="font_face_d.png" x=&tf.config_button_0_x_4 y=&tf.font_button_6_y visible=true]
[image layer=1  name="font_face_button" page=fore storage="config_button_0.png" x=&tf.config_button_0_x_4 y=&tf.font_button_6_y visible=true]
[else]
[button fix="true"  name="font_face_button" target="*text_test" exp="sf.font_f=6" graphic="font_face_d.png" x=&tf.config_button_0_x_4 y=&tf.font_button_6_y]
[image layer=1  name="font_face_button" page=fore storage="config_button_1.png" x=&tf.config_button_0_x_4 y=&tf.font_button_6_y visible=true]
[endif]

;1
[if exp="sf.font_f==1"]
[image layer=2 name="font_face_button" page=fore  storage="font_face_e.png" x=&tf.config_button_0_x_5 y=&tf.font_button_6_y visible=true]
[image layer=1  name="font_face_button" page=fore storage="config_button_0.png" x=&tf.config_button_0_x_5 y=&tf.font_button_6_y visible=true]
[else]
[button fix="true"  name="font_face_button" target="*text_test" exp="sf.font_f=1" graphic="font_face_e.png" x=&tf.config_button_0_x_5 y=&tf.font_button_6_y]
[image layer=1  name="font_face_button" page=fore storage="config_button_1.png" x=&tf.config_button_0_x_5 y=&tf.font_button_6_y visible=true]
[endif]


;[if exp="sf.font_f==6"]
;[button fix="true"  name="font_f_button" target="*font_f" graphic=font_cursor.gif exp="sf.font_f=5" x=&tf.font_button_cursor_x y=&tf.font_button_cursor_y]
;[elsif exp="sf.font_f==5"]
;[button fix="true"  name="font_f_button" target="*font_f" graphic=font_cursor.gif exp="sf.font_f=3" x=&tf.font_button_cursor_x y=&tf.font_button_cursor_y]
;[elsif exp="sf.font_f==3"]
;[button fix="true"  name="font_f_button" target="*font_f" graphic=font_cursor.gif exp="sf.font_f=2" x=&tf.font_button_cursor_x y=&tf.font_button_cursor_y]
;[elsif exp="sf.font_f==2"]
;[button fix="true"  name="font_f_button" target="*font_f" graphic=font_cursor.gif exp="sf.font_f=6" x=&tf.font_button_cursor_x y=&tf.font_button_cursor_y]
;[else]
;[button fix="true"  name="font_f_button" target="*font_f" graphic=font_cursor.gif exp="sf.font_f=1" x=&tf.font_button_cursor_x y=&tf.font_button_cursor_y]
;[endif]
...
[if exp="sf.font_f==6"]
ほのかアンティーク[wait time=350][er]
@layopt layer=message0 visible=false

[elsif exp="sf.font_f==5"]
まめろん[wait time=350][er]
@layopt layer=message0 visible=false

[elsif exp="sf.font_f==3"]
むげんプラス[wait time=350][er]
@layopt layer=message0 visible=false

[elsif exp="sf.font_f==2"]
はんなり明朝[wait time=350][er]
@layopt layer=message0 visible=false

[else]
デフォルト[wait time=350][er]
@layopt layer=message0 visible=false
