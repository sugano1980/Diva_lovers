...
;239
 [if exp="tf.kouhou_suuti>239"]
 [eval exp="f.kouhou_score =1"]
 [elsif exp="tf.kouhou_suuti>179"]
...
[endif]
 ...
 [if exp="f.kouhou_score==1&&f.kouhou_rans==1"]
 [rans_a_kouhou]
 [elsif exp="f.kouhou_score==2&&f.kouhou_rans==1"]
 [rans_b_kouhou]
 [endif]
  ...
  [if exp="f.kouhou_score==1&&f.kouhou_lion==1"]
  [lion_a_kouhou]
 [elsif exp="f.kouhou_score==2&&f.kouhou_lion==1"]
   [lion_b_kouhou]
 [endif]
  ...
  [if exp="f.kouhou_score==1&&f.kouhou_kra==1"]
  [kra_a_kouhou]
 [elsif exp="f.kouhou_score==2&&f.kouhou_kra==1"]
  [kra_b_kouhou]
 [endif]


 
  [if exp="f.kouhou_glif==1&&f.kouhou_score==1"]
  [glif_a_kouhou]
 [elsif exp="f.kouhou_score==2&&f.kouhou_glif==1"]
  [glif_b_kouhou]
 [endif]
...
[eval exp="f.kouhou_rans=0"]
[eval exp="f.kouhou_lion=0"]
[eval exp="f.kouhou_kra=0"]
[eval exp="f.kouhou_glif=0"]
 [endmacro]
...
#ランスロット
「王宮騎士団で支給されているものだが・・・お前にも役に立つだろう」[p]
#

[event_other_item_get_rans]
...
[aho_face_yokome_warai]
#クライスト	
「あ、そうだ、[name]ちゃんにこれ。こないだ王宮にきてた行商人から買ったんだけど」[p]
#
...
・・・それじゃあね、おやすみ」[p]
#
[live2d_fadeout time=1000][live2d_delete_all][live2d_off]
[endmacro]
...
#グリフ	
「あ、そうだこれ、もしよかったら使ってください」[p]
#

[event_other_item_get_glif]
