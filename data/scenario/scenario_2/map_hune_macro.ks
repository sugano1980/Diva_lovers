...
[image layer=2 page=fore visible=true storage="event_sub.gif" name="event" x=200 y=140]
[endif]
;お店アイコン;でーと中のみ
...
[image layer=2 page=fore visible=true storage="event_sub.gif" name="event" x=420 y=190]
[endif]
...
;甲板
[locate x=355 y=30]
[clickable width=120 height=130 mouseopacity=37 opacity=0 color=gray target=*kanpan]

;食堂
[locate x=190 y=150]
[clickable width=90 height=130 mouseopacity=37 opacity=0 color=gray target=*shokudou]
