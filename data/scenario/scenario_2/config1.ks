...
[freeimage layer=3]
@clearfix
[if exp="f.kyuujitu==1&&f.irain_heya==1&&f.place_creru_oukyu!=1&&f.place_creru_hunsui!=1&&f.place_creru_sakaba!=1&&f.place_creru_gaia!=1&&f.place_creru_uradoori!=1&&f.place_creru_out!=1"]
