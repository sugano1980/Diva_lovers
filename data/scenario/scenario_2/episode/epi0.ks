...
[mil][hidemenubutton][button_menu][l][k][cm][ka]
...
[r]（モンスター！！）[ikkatu]
[playse storage="monster-snore02_kurage.ogg"  loop=false]
...
[stopbgm]
[r][r][r][r][r][w][w][w]それから、[w][w]八年。[mil][hidemenubutton][button_menu][l][k][cm][ka]
