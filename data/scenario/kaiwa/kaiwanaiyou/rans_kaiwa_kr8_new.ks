...
[baka_head_right_x]
[baka_body_right_z]
[live2d_motion name="baka0" mtn="Exp_mehuse_warai_kutiake"]
#ランスロット
「当初は、父上にも反対されていたし、
[r]どうなることかと思ったのだが・・・」[p]
#
...
[jump storage="kaiwa/ranskaiwa_new.ks" target=*wadaichoice][r]
...
[live2d_motion name="baka0" mtn="Exp_yokome_kutiake"]
#ランスロット
「お前には申し訳ないが・・・私は少し・・・」[p]#
...
[r]私にはよく理解できない」[p]#
[live2d_motion name="baka0" mtn="Exp_muzukasii_mehuse"]
...
[if exp="f.jiyuu>7"]
[live2d_motion name="baka0" mtn="Exp_yokome"]
[live2d_motion name="baka0" mtn="Exp_mehuse_mousiwakenai_kutiake"]
#ランスロット
「この間も町でみかけたが・・・
[r]また女性に声をかけていた」[p]#
...
[live2d_motion name="baka0" mtn="Exp_sinnpai_kutiake"]
#ランスロット
「どんな考えだ？それは」[p]#
[live2d_motion name="baka0" mtn="Exp_sinnpai"]
...
[live2d_motion name="baka0" mtn="Exp_yokome"]
[live2d_motion name="baka0" mtn="Exp_ketui_kutiake"]
#ランスロット
「考えても見ろ、ああいう男だ。
...
[live2d_motion name="baka0" mtn="Exp_mehuse_muzukasii_kutiake"]
#ランスロット
「全面的にはまだ、信用するべきではないと思っている」[p]#
[live2d_motion name="baka0" mtn="Exp_metoji_kutiake"]
#ランスロット
「まだ知り合って日も浅いしな。
[live2d_motion name="baka0" mtn="Exp_mehuse_kutiake"]
[r]特にお前には、なにか特別な感情を持っているように思える」[p]#
[live2d_motion name="baka0" mtn="Exp_normal_majime"]
...
[live2d_motion name="baka0" mtn="Exp_kessin_kutiake"]
#ランスロット
...
[live2d_motion name="baka0" mtn="Exp_muzukasii_mehuse_kutiake"]
#ランスロット
...
[live2d_motion name="baka0" mtn="Exp_mousiwakenai"]

[komari_kutitoji]
#&f.name
「どうして？」[p]#

[live2d_motion name="baka0" mtn="Exp_normal_kutiake"]
#ランスロット
「それは・・・
[live2d_motion name="baka0" mtn="Exp_yokome_kutiake"]
その」[p]#
