...
[clearfix_item]
[eval exp="f.battle_item_3_stock=f.battle_item_3_stock-1"]
;毒解除
...
[free layer=3 name="anime_leaf_goshinboku" time=50]
...
[eval exp="tf.anime_leaf_goshinboku_friend_x=tf.friend_face_x]
