...
[free name="item_suuti" layer=2]
[eval exp="tf.suuti_delete=0"]
[jump storage="equip_item_hyouji.ks" target=*item_hyouji2]
[endif]
...
tyrano.plugin.kag.variable.tf.equip_item_explain_19,
tyrano.plugin.kag.variable.tf.equip_item_explain_20,
tyrano.plugin.kag.variable.tf.equip_item_explain_21,
tyrano.plugin.kag.variable.tf.equip_item_explain_22,
tyrano.plugin.kag.variable.tf.equip_item_explain_23,
tyrano.plugin.kag.variable.tf.equip_item_explain_24,
tyrano.plugin.kag.variable.tf.equip_item_explain_25,
tyrano.plugin.kag.variable.tf.equip_item_explain_26,
tyrano.plugin.kag.variable.tf.equip_item_explain_27,
tyrano.plugin.kag.variable.tf.equip_item_explain_28,
tyrano.plugin.kag.variable.tf.equip_item_explain_29,
tyrano.plugin.kag.variable.tf.equip_item_explain_30,
tyrano.plugin.kag.variable.tf.equip_item_explain_31,
tyrano.plugin.kag.variable.tf.equip_item_explain_32,
tyrano.plugin.kag.variable.tf.equip_item_explain_33,
tyrano.plugin.kag.variable.tf.equip_item_explain_34
];
tyrano.plugin.kag.variable.tf.equip_trush_value=0;
...
if(tyrano.plugin.kag.variable.tf.equip_shori_no[i]==1&&tyrano.plugin.kag.variable.tf.item_hyouji_confirm[i]==1){
	...
	if(i>27){
     ...
     var o = i*45;		                    
	                        ...
	                        tyrano.plugin.kag.variable.tf.equip_item_y_trush = tyrano.plugin.kag.variable.tf.equip_key_y - 15;
	             i+=1;o=0;
	 if(big==3){
	 	i+=9; big=0;
	 	}else if(big==2){
	...
	tyrano.plugin.kag.variable.tf.equip_trush_value = i;
...
;equip_trush[1]の変数に１代入
[button graphic="trush.png" fix=true storage="item_trush.ks" target=*equip_item_1_trush name="equip" x=&tf.equip_item_x_trush y=&tf.equip_item_y_trush]

[eval exp="tf.explain_true=0"]
;元シナリオへジャンプ
[jump storage="equip_item_hyouji.ks" target=*hyouji_end]
[endif]
...
[free name="item_suuti_5" layer=2]
[elsif exp="tf.equip_item_6>0"]
[free name="item_suuti_6" layer=2]
[elsif exp="tf.equip_item_7>0"]
[free name="item_suuti_7" layer=2]
[elsif exp="tf.equip_item_8>0"]
[free name="item_suuti_8" layer=2]
[elsif exp="tf.equip_item_9>0"]
[free name="item_suuti_9" layer=2]
[endif]
;--------------
...
[if exp="tf.equip_item_1==1&&tf.equip_item_hyouji_1==1"]
;アイテム欄１回でアップステータス数値表示と説明
[free name="key" layer=2]
[image layer=2 page=fore storage="key_cursor.png" name="key" x=&tf.item1_key_x y=&tf.item1_key_y]

;アイテム説明
[ptext layer=2 page=fore text=&tf.equip_item_explain_1 face=antique name="item_suuti" size=&tf.font_size x=&tf.item_explain_x y=&tf.item_explain_y]
;他のアイテムの説明が表示してあれば消去
